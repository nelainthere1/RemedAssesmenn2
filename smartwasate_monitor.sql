...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Jun 2026 pada 12.38
...
CREATE TABLE `monitoring` (
  ...
  `lokasi_tempat_sampah` varchar(255) NOT NULL,
  `waktu_monitoring` datetime NOT NULL,
  `volume_sampah` int(11) NOT NULL,
  `status_kondisi` enum('Ringan','Sedang','Berat') NOT NULL,
